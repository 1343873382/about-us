 ...
 * @LastEditTime: 2021-03-10 20:00:27
...
const bigSize = fontSize(60)
const midSize = fontSize(45)
const smallSize = fontSize(30)
const pmOffset = 5
const pmList = [
...
const webList = [
  ...
  { pos: 93, opacity: 8, txt: "发送你的简历（邮件主题命名：前端/后端-学号-姓名，如：后端-2020xxxxxx关月金，在简历中留下你的QQ号码，并以PDF格式发送）至web@redrock.team", scle: true, fontSize: smallSize },
]
const mobileList = [
...
const sreList = [
  ...
  { pos: 180, opacity: 14, txt: "发送你的简历（邮件主题命名：方向-学号-姓名，如：DBA-2020114514-李田所，在正文中留下你的QQ号码，若有github项目地址则一并写入正文，并以PDF格式发送）至sre@redrock.team如无上述技能，但想加入我们，也欢迎前来报名，我们会酌情考量并进行相关培训（包教会。", scle: true, fontSize: smallSize },
]
const designList = [
